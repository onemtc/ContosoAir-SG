[![Build Status](https://dev.azure.com/onemtc/ContosoAir-SG/_apis/build/status/onemtc.ContosoAir-SG?branchName=master)](https://dev.azure.com/onemtc/ContosoAir-SG/_build/latest?definitionId=77&branchName=master)
